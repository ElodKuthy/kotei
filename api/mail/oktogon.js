...
const from = '360Gym Oktogon <no-reply@kotei.hu>'

const sendResetPasswordToken = {
    subject: '360Gym Oktogon - Elfelejtett jelszó',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>
            ...
            <a href="https://oktogon.kotei.hu/reset-password/${token}">https://oktogon.kotei.hu/reset-password/${token}</a><br/>
        </div>
...
const sendRegistration = {
    subject: '360Gym Oktogon - Üdvözlünk',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>Nagyon örülünk, hogy a 360Gym Oktogon Terem tagjainak körében üdvözölhetünk!</div>

        <div>
            A 360Gym Oktogon Terem Kotei használatához aktiválnod kell a felhasználódat és megadnod egy jelszót, amit a következő linken tudsz megtenni:<br/>
            <a href="https://oktogon.kotei.hu/reset-password/${token}">https://oktogon.kotei.hu/reset-password/${token}</a><br/>
        </div>

        <div>
            A 360Gym Oktogon Terem Koteit az alábbi webcímen tudod elérni:<br/>
            <a href="https://oktogon.kotei.hu">https://oktogon.kotei.hu</a><br/>
...
const sendSubscriptionAlmostDepletedNotification = {
    subject: '360Gym Oktogon - Emlékeztető bérlet lejáratáról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendNewSubscriptionNotification = {
    subject: '360Gym Oktogon - Emlékeztető bérlet vásárlásról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendCancelledTrainingNotification = {
    subject: '360Gym Oktogon - Elmarad egy óra',
