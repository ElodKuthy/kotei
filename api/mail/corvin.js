...
const sendRegistration = {
    ...
    html: (user, token) =>
        ...
        <div>Ha további kérdéseid lennének, fordulj bizalommal oktatódhoz személyesen, vagy írj nekünk a <a href="mailto:corvin@kotei.hu">corvin@kotei.hu</a> email címre.</div>
...
const sendCancelledTrainingNotification = {
    subject: '360Gym Corvin - Elmarad egy óra',
