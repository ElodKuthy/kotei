...
const from = '360Gym Zugló <no-reply@kotei.hu>'

const sendResetPasswordToken = {
    subject: '360Gym Zugló - Elfelejtett jelszó',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>
            ...
            <a href="https://zuglo.kotei.hu/reset-password/${token}">https://zuglo.kotei.hu/reset-password/${token}</a><br/>
        </div>
...
const sendRegistration = {
    subject: '360Gym Zugló - Üdvözlünk',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>Nagyon örülünk, hogy a 360Gym Zugló Terem tagjainak körében üdvözölhetünk!</div>

        <div>
            A 360Gym Zugló Terem Kotei használatához aktiválnod kell a felhasználódat és megadnod egy jelszót, amit a következő linken tudsz megtenni:<br/>
            <a href="https://zuglo.kotei.hu/reset-password/${token}">https://zuglo.kotei.hu/reset-password/${token}</a><br/>
        </div>

        <div>
            A 360Gym Zugló Terem Koteit az alábbi webcímen tudod elérni:<br/>
            <a href="https://zuglo.kotei.hu">https://zuglo.kotei.hu</a><br/>
...
const sendSubscriptionAlmostDepletedNotification = {
    subject: '360Gym Zugló - Emlékeztető bérlet lejáratáról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendNewSubscriptionNotification = {
    subject: '360Gym Zugló - Emlékeztető bérlet vásárlásról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendCancelledTrainingNotification = {
    subject: '360Gym Zugló - Elmarad egy óra',
