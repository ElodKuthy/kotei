...
const from = 'Test Gym <no-reply@kotei.hu>'

const sendResetPasswordToken = {
    subject: 'Test Gym - Elfelejtett jelszó',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendRegistration = {
    ...
    html: (user, token) =>
        ...
        <div>Nagyon örülünk, hogy a Test Gym Terem tagjainak körében üdvözölhetünk!</div>

        <div>
            A Test Gym Terem Kotei használatához aktiválnod kell a felhasználódat és megadnod egy jelszót, amit a következő linken tudsz megtenni:<br/>
            <a href="https://test.kotei.hu/reset-password/${token}">https://test.kotei.hu/reset-password/${token}</a><br/>
        </div>

        <div>
            A Test Gym Terem Koteit az alábbi webcímen tudod elérni:<br/>
...
const sendSubscriptionAlmostDepletedNotification = {
    subject: 'Test Gym - Emlékeztető bérlet lejáratáról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendNewSubscriptionNotification = {
    subject: 'Test Gym - Emlékeztető bérlet vásárlásról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
