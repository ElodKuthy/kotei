...
const from = '360Gym Omszk Park <no-reply@kotei.hu>'

const sendResetPasswordToken = {
    subject: '360Gym Omszk Park - Elfelejtett jelszó',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>
            ...
            <a href="https://omszk.kotei.hu/reset-password/${token}">https://omszk.kotei.hu/reset-password/${token}</a><br/>
        </div>
...
const sendRegistration = {
    subject: '360Gym Omszk Park - Üdvözlünk',
    html: (user, token) =>
        `<html>
        <head>
            <style type="text/css">
        ...
        <div>Nagyon örülünk, hogy a 360Gym Omszk Park Terem tagjainak körében üdvözölhetünk!</div>

        <div>
            A 360Gym Omszk Park Terem Kotei használatához aktiválnod kell a felhasználódat és megadnod egy jelszót, amit a következő linken tudsz megtenni:<br/>
            <a href="https://omszk.kotei.hu/reset-password/${token}">https://omszk.kotei.hu/reset-password/${token}</a><br/>
        </div>

        <div>
            A 360Gym Omszk Park Terem Koteit az alábbi webcímen tudod elérni:<br/>
            <a href="https://omszk.kotei.hu">https://omszk.kotei.hu</a><br/>
...
const sendSubscriptionAlmostDepletedNotification = {
    subject: '360Gym Omszk Park - Emlékeztető bérlet lejáratáról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendNewSubscriptionNotification = {
    subject: '360Gym Omszk Park - Emlékeztető bérlet vásárlásról',
    html: (subscription) =>
        `<html>
        <head>
            <style type="text/css">
...
const sendCancelledTrainingNotification = {
    subject: '360Gym Omszk Park - Elmarad egy óra',
